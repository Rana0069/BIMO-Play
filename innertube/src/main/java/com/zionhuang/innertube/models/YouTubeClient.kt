...
data class YouTubeClient(
    ...
    companion object {
        ...
        /**
         * ANDROID_VR client without authentication. Currently the only client that reliably
         * returns usable streams without triggering 403 from the YouTube CDN.
         * Does not require PoTokens or signature timestamps.
         */
